...
# "LLM Reranking with Sentence Context" linking strategy on a Filtered KB.
#
# Key Characteristics:
# 1. Filtered KB: Uses a pre-cleaned version of the Freebase dataframe (removing 
#    short/stopword entity names) to reduce noise in vector retrieval.
# 2. Context Strategy: The LLM reranker is provided with the specific *original 
#    sentence* from the source text where the entity appeared.
# 3. Logic: It pre-computes an entity-to-sentence map using spaCy to provide 
#    precise linguistic context for the disambiguation step.
# ==============================================================================
