...
# SCRIPT DESCRIPTION
# ==============================================================================
# This script executes the Knowledge Graph generation experiment using a 
# "VectorDB-Only" linking strategy. 
#
# Key Characteristics:
# 1. Standardization: Maps generated entities and predicates to the Knowledge Base 
#    (Freebase) relying solely on vector embedding similarity (top-1 match).
# 2. No LLM Reranking: Unlike other variations, this script does not employ a 
#    secondary LLM step to disambiguate candidates; it trusts the VectorDB result.
# 3. Baselines: Compares the LLM generation against Distant Supervision and 
#    SVO Pattern Matching baselines.
# ==============================================================================
...
if __name__ == '__main__':
    ...
    output_filename = f"llmgrapher_experiment_vectordb-only_linking_{num_texts}_{start_time_str}_{duration_minutes}min.csv"
