...
def pair_graphs_with_wikitext(subset: str, wikitext_raw_dir, graph_dir: str, output_dir: str):
  ...
  wikitext_articles = list(wikitext.RawDataset(data_dir=wikitext_raw_dir, subset=subset, version='raw'))
