...
# "LLM Reranking with Triplet Context" strategy on a Filtered KB.
#
# Key Characteristics:
# 1. Filtered KB: Loads (or builds) a filtered version of Freebase that excludes 
#    junk entities (e.g., 1-2 character names or stopwords) to improve retrieval precision.
# 2. Context Strategy: Uses the "Triplet Context" approach, where the LLM judge 
#    sees the entity's neighbors in the graph to make linking decisions.
# 3. Optimization: Features bug fixes in dependency loading and utilizes Parquet 
#    caching for the filtered dataframe to speed up initialization.
# ==============================================================================
